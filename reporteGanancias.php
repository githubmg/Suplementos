...
<div class="colmask leftmenu">
	<div class="colleft">
		...
		<?php
			...
			$idsItemVentas = DB::getIdsItemVentasByParamGanancia($fecha_desde, $fecha_hasta, $idProducto, $subempresa, $indexMenu);
			$cantidad = DB::getCantidadDePaginasIVByParamGanancia($fecha_desde, $fecha_hasta, $idProducto, $subempresa);
			echo MenuView::getMenuHTML($menuSeleccionado);
                        echo ReporteGanancias::getTotalesHTML($fecha_desde, $fecha_hasta, $idProducto, $subempresa);
                        echo "<br>";
			echo ReporteGanancias::getListadoHTML($idsItemVentas,$cantidad, $_GET);
